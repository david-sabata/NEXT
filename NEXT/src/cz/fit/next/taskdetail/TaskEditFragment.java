...
public class TaskEditFragment extends Fragment implements ServiceReadyListener {
	...
	private void loadTaskToView(Task task) {
		...
		ArrayAdapter<String> adapter = new ArrayAdapter<String>(getActivity(), R.layout.spinner_item_new_solution, contextsStrings);
		AutoCompleteTextView textView = (AutoCompleteTextView) taskDetailView.findViewById(R.id.editContext);
